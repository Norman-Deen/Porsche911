...
//intro film
const CUT1_START = {
  pos:{ x: 0.7421, y: 3.5087, z: 3.3473 },
  target:{ x: -0.3818, y: -0.6204, z: 1.6331 }
};
const CUT1_END = {
  pos:{ x: 0.7285, y: 2.9066, z: 4.8065 },
  target:{ x: -0.3953, y: -1.2225, z: 3.0923 }
};

const CUT2_START = {
  pos:{ x: -1.7953, y: 1.3541, z: -2.5815 },
  target:{ x: 0.3090, y: 0.3119, z: 1.6651 }
};
const CUT2_END = {
  pos:{ x: -1.9747, y: 0.3709, z: -2.7339 },
  target:{ x: 0.1296, y: -0.6713, z: 1.5127 }
};

const CUT3_START = {
  pos:{ x: 0.5499, y: 1.6371, z: -3.2818 },
  target:{ x: 0.8711, y: 0.2554, z: 0.4582 }
};
const CUT3_END = {
  pos:{ x: -0.0803, y: 1.3637, z: -3.2656 },
  target:{ x: 0.8711, y: 0.2554, z: 0.4582 }
};

const CUT4_START = {
  pos:{ x: -1.1025, y: 4.1833, z: -1.4805 },
  target:{ x: 0.5602, y: -0.1985, z: 0.3713 }
};
const CUT4_END = {
  pos:{ x: 1.9157, y: 4.6550, z: 0.3827 },
  target:{ x: 0.5602, y: -0.1985, z: 0.3713 }
};
...
const MAIN_CAM = (window.innerWidth <= 768)
  ...
  : { pos:{ x:5.1,  y:4.6,  z:7.2  }, target:{ x:0, y:0, z:0 } };  // ديسكتوب
...
const FRAMES = [
  ...
  {pos:{x:1.1114,y:10.5545,z:1.4196},target:{x:1.1108,y:-0.0404,z:0.7378}}, // cut10
  {pos:{x:1.3883,y:10.5494,z:1.4411},target:{x:1.1108,y:-0.0404,z:0.7378}}, // cut11
  {pos:{x:2.3969,y:10.4252,z:1.9761},target:{x:1.1108,y:-0.0404,z:0.7378}}, // cut12
  {pos:{x:3.9193,y:10.1046,z:2.1190},target:{x:1.1108,y:-0.0404,z:0.7378}}, // cut13
  {pos:{x:6.1840,y:9.2430,z:3.8424}, target:{x:1.1109,y:-0.0404,z:0.7378}}, // cut14
  {pos:{x:4.2400,y:8.8948,z:4.8689}, target:{x:1.1109,y:-0.0404,z:0.7378}}, // cut15
  {pos:{x:2.2959,y:8.5466,z:5.8954}, target:{x:1.1109,y:-0.0404,z:0.7378}}, // cut16
  {pos:{x:0.3519,y:8.1984,z:6.9218}, target:{x:1.1109,y:-0.0404,z:0.7378}}, // cut17
  {pos:{x:-1.5921,y:7.8501,z:7.9483},target:{x:1.1109,y:-0.0404,z:0.7378}}, // cut18
  {pos:{x:-2.1823,y:8.3577,z:6.3542},target:{x:0.6874,y:-0.1793,z:0.7804}}, // cut19
  {pos:{x:-2.7725,y:8.8653,z:4.7601},target:{x:0.2639,y:-0.3182,z:0.8230}}, // cut20
  {pos:{x:-3.9528,y:9.8806,z:1.5720},target:{x:-0.5830,y:-0.5960,z:0.9081}},// cut21
  {pos:{x:-0.5835,y:10.1543,z:1.2401},target:{x:-0.5835,y:-0.5962,z:0.9082}},// cut22
  {pos:{x:-0.5835,y:10.4291,z:0.9082},target:{x:-0.5835,y:-0.5962,z:0.9082}},// cut23
  {pos:{x:-0.4374,y:10.3963,z:0.6828},target:{x:-0.4374,y:-0.6289,z:0.6828}},// cut24
  {pos:{x:-0.2913,y:10.3636,z:0.4574},target:{x:-0.2913,y:-0.6616,z:0.4574}} // cut25
];
...
const LOOP_FRAMES = [
  ...
  FRAMES[0] // يرجع بالعكس بدون تكرار الأول/الأخير
];
...
export function playDemoCamera(camera, controls, { ease="sine.inOut", seg=4 } = {}) {
 ...
 for (let i = 0; i < LOOP_FRAMES.length - 1; i++) {
  const a = LOOP_FRAMES[i];
  const b = LOOP_FRAMES[i + 1];
